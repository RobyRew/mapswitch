...
export function shareActionsStrings(locale: Locale): ShareActionsStrings {
  return {
    ...
    linkType: t(locale, 'chooser.share.linkType'),
    ...
    downloadQr: t(locale, 'chooser.share.downloadQr'),
    customSlugPlaceholder: t(locale, 'chooser.share.customSlugPlaceholder'),
    customSlugClaim: t(locale, 'chooser.share.customSlugClaim'),
    slugChecking: t(locale, 'chooser.share.slugChecking'),
    slugAvailable: t(locale, 'chooser.share.slugAvailable'),
    slugTaken: t(locale, 'chooser.share.slugTaken'),
    slugInvalid: t(locale, 'chooser.share.slugInvalid'),
